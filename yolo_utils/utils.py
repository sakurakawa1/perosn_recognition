...
def strip_optimizer(f='weights/best.pt'):  # from yolo_utils.yolo_utils import *; strip_optimizer()
...
def create_backbone(f='weights/best.pt'):  # from yolo_utils.yolo_utils import *; create_backbone()
...
def kmean_anchors(path='./data/coco64.txt', n=9, img_size=(640, 640), thr=0.20, gen=1000):
    # Creates kmeans anchors for use in *.cfg files: from yolo_utils.yolo_utils import *; _ = kmean_anchors()
    # n: number of anchors
...
def plot_evolution_results(hyp):  # from yolo_utils.yolo_utils import *; plot_evolution_results(hyp)
...
def plot_results(start=0, stop=0, bucket='', id=()):  # from yolo_utils.yolo_utils import *; plot_results()
